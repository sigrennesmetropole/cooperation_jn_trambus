import { aw as defineComponent, aN as ref, aA as openBlock, ay as createBlock, aL as computed, aE as createElementBlock, aH as createBaseVNode, aM as normalizeClass, aJ as toDisplayString, aF as Fragment, aG as renderList, aI as createCommentVNode, aC as reactive, aP as onBeforeMount, aQ as pushScopeId, aR as popScopeId, ax as resolveComponent, az as withCtx, aB as createVNode } from "./vendor.8549447d.js";
import { a as IconCircleText, I as IconLine } from "./IconLine.7b9ef2e0.js";
import { a as getColorBus, g as getColorLine } from "./color.12f233df.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper.cdc0426e.js";
import { a as apiClientService } from "./api.client.28da34a9.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { props, state, ItemThermometerStations };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
      ...
      $setup.state.stations !== null && $setup.state.stations.length > 0 ? (openBlock(), createElementBlock("ul", _hoisted_2, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($setup.state.stations, (station, index) => {
          return openBlock(), createBlock($setup["ItemThermometerStations"], {
            ...
            is_last_elem: index + 1 === $setup.state.stations.length ? true : false
          }, null, 8, ["index", "line", "name", "parking", "desserte", "li_code", "is_last_elem"]);
        }), 128))
      ])) : createCommentVNode("v-if", true)
    ])
  ], 64);
