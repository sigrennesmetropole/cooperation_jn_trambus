import { aw as defineComponent, aC as reactive, b4 as useRouter, aD as onMounted, aK as ref, aA as openBlock, aE as createElementBlock, aH as createBaseVNode, aF as Fragment, aG as renderList, ay as createBlock, aP as normalizeClass, aB as createVNode, b5 as Gt } from "./vendor.bc3132df.js";
import { a as apiClientService, u as useLayersStore } from "./api.client.0d5166f0.js";
import { U as UiLineDescription } from "./UiLineDescription.906823ca.js";
import { u as useHomeViewsStore, a as useViewsStore, b as useMap3dStore, c as useLineInteractionStore } from "./views.4b1c9d06.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { layerStore, viewStore, map3dStore, lineInteractionStore, panelsStore, LineDescriptions, TravelTimes, UiTrambusTitle, FooterArea: Gt, SkipLinksHome };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
