import { aw as defineComponent, bm as inject, aK as ref, aD as onMounted, aA as openBlock, aE as createElementBlock, aF as Fragment, aG as renderList, ay as createBlock, aI as createCommentVNode, aH as createBaseVNode, bG as useRoute, aC as reactive, aV as onBeforeMount, aB as createVNode, b5 as XM } from "./vendor.ff13d028.js";
import { b as useMap3dStore, a as useViewsStore, f as usePoiParkingStore, c as useLineInteractionStore, v as viewList } from "./views.1e6e4702.js";
import { R as RENNES_LAYER, u as useLayersStore, a as apiClientService } from "./api.client.7f072773.js";
import { u as useStationsStore } from "./stations.1ed4ca47.js";
import { U as UiStationHeader } from "./UiStationHeader.c730e267.js";
import { S as ServicesStation } from "./ServicesStation.4e64794d.js";
import { I as ItemPOI } from "./ItemPOI.4fe08b7a.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { map3dStore, viewStore, layerStore, stationsStore, poiStore, lineInteractionStore, params, routeParams, stationId, lineNumber, state, rennesApp, UiStationHeader, FooterArea: XM, ServicesStation, PointsOfInterestsStation, BackButton };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
