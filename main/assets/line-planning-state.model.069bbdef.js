...
import { aK as defineStore, aL as ref, aw as defineComponent, aA as openBlock, aE as createElementBlock, aF as Fragment, aG as renderList, a$ as normalizeStyle, aH as createBaseVNode, aJ as toDisplayString, aY as withDirectives, b0 as vModelRadio } from "./vendor.fe3c811e.js";
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList($setup.props.lines, (line) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("label", {
          for: line.id
        }, toDisplayString(line.printValue), 9, _hoisted_9),
        _hoisted_10,
        withDirectives(createBaseVNode("input", {
          type: "radio",
          name: "line",
