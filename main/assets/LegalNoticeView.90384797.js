import { aw as defineComponent, aA as openBlock, aE as createElementBlock, aH as createBaseVNode, aQ as renderSlot, b5 as useRouter, bH as useRoute, aL as ref, ay as createBlock, az as withCtx, aG as renderList, aP as normalizeClass, bM as withKeys, aJ as toDisplayString, aF as Fragment, aW as createStaticVNode, aV as onBeforeMount, aB as createVNode, aI as createCommentVNode } from "./vendor.9aefb857.js";
import { a as useViewsStore } from "./views.1abd36d8.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper.cdc0426e.js";
import { l as legalList } from "./legalLinks.47be5507.js";
import "./layers.ef7a09c2.js";
import "./stations.8b701e80.js";
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { restartHome };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
const _hoisted_1$7 = { class: "absolute top-0 left-0 flex flex-row items-center justify-between px-9 gap-12 w-[100%] h-[72px] bg-white shadow z-40" };
const _hoisted_2$7 = { class: "flex flex-row items-center" };
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$7, [
    ...
    createBaseVNode("div", null, [
      createBaseVNode("button", {
        onClick: _cache[0] || (_cache[0] = ($event) => $setup.restartHome()),
...
_sfc_main$7.__file = "src/components/legal/UiHeaderFullScreen.vue";
const UiHeaderFullScreen = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$7], ["__file", "/home/runner/work/cooperation_jn_trambus/cooperation_jn_trambus/src/components/legal/UiHeaderFullScreen.vue"]]);
...
const iconMultiplyBlack = "/cooperation_jn_trambus/main/assets/icon-multiply-black.572055b3.svg";
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { router, params, routeParams, legalLink, goTo, UiHeaderFullScreen, logoRennes, iconMultiplyBlack, legalList };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
const _hoisted_1$6 = ["src"];
const _hoisted_2$6 = { class: "flex flex-row self-end gap-4" };
const _hoisted_3$3 = ["onClick", "onKeydown"];
const _hoisted_4$3 = ["src"];
const _hoisted_5$1 = /* @__PURE__ */ createBaseVNode("span", { class: "text-base font-medium" }, "Fermer", -1);
      ...
      createBaseVNode("div", _hoisted_2$6, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($setup.legalList, (item) => {
          return openBlock(), createElementBlock("div", {
            ...
            }, toDisplayString(item.name), 41, _hoisted_3$3)
          ], 2);
        }), 128))
      ])
    ]),
    "button-content": withCtx(() => [
      createBaseVNode("img", { src: $setup.iconMultiplyBlack }, null, 8, _hoisted_4$3),
      _hoisted_5$1
    ]),
    _: 1
  });
}
_sfc_main$6.__file = "src/components/legal/HeaderLegalNotice.vue";
const HeaderLegalNotice = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$6], ["__file", "/home/runner/work/cooperation_jn_trambus/cooperation_jn_trambus/src/components/legal/HeaderLegalNotice.vue"]]);
const expandIcon = "/cooperation_jn_trambus/main/assets/expand-small-bigger-retract-smaller-big.86c6fe46.svg";
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  __name: "LegalNotice",
  setup(__props, { expose }) {
    expose();
    const __returned__ = { expandIcon };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
const _hoisted_1$5 = { class: "flex flex-col gap-12 w-[880px] h-fit bg-white rounded-xl px-8 py-16 mx-auto mt-32 mb-[78px]" };
const _hoisted_2$5 = /* @__PURE__ */ createBaseVNode("h1", { class: "text-[44px] leading-[48px] lmb-12 font-bold" }, " Mentions l\xE9gales ", -1);
const _hoisted_3$2 = { class: "flex flex-col gap-8 text-base font-normal" };
const _hoisted_4$2 = /* @__PURE__ */ createBaseVNode("p", null, " Nos devoirs et obligations : toutes les informations obligatoires du pr\xE9sent site internet. ", -1);
...
const LegalNotice = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$5], ["__file", "/home/runner/work/cooperation_jn_trambus/cooperation_jn_trambus/src/components/legal/LegalNotice.vue"]]);
const iconCheckGreen = "/cooperation_jn_trambus/main/assets/icon-check-green.383247bb.svg";
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  __name: "PrivacyLegal",
  setup(__props, { expose }) {
    expose();
    const __returned__ = { iconCheckGreen };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
const _hoisted_1$4 = { class: "flex flex-col gap-12 w-[880px] h-fit bg-white rounded-xl px-8 py-16 mx-auto mt-32 mb-[79px]" };
...
const Privacy = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__file", "/home/runner/work/cooperation_jn_trambus/cooperation_jn_trambus/src/components/legal/PrivacyLegal.vue"]]);
const _sfc_main$3 = {};
const _hoisted_1$3 = { class: "flex flex-col gap-12 w-[880px] h-fit bg-white rounded-xl px-8 py-16 mx-auto mt-32 mb-[87px]" };
const _hoisted_2$3 = /* @__PURE__ */ createBaseVNode("h1", { class: "flex flex-column align-start text-[44px] leading-[48px] lmb-12 font-bold" }, " Plan du site ", -1);
const _hoisted_3$1 = /* @__PURE__ */ createBaseVNode("div", { class: "text-base font-normal" }, null, -1);
const _hoisted_4$1 = [
  _hoisted_2$3,
  _hoisted_3$1
];
...
const SiteMap = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["__file", "/home/runner/work/cooperation_jn_trambus/cooperation_jn_trambus/src/components/legal/SiteMap.vue"]]);
const _sfc_main$2 = {};
...
const Accessibility = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["__file", "/home/runner/work/cooperation_jn_trambus/cooperation_jn_trambus/src/components/legal/AccessibilityLegal.vue"]]);
const _sfc_main$1 = {};
...
const Cookies = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__file", "/home/runner/work/cooperation_jn_trambus/cooperation_jn_trambus/src/components/legal/CookiesLegal.vue"]]);
...
const _hoisted_2 = { class: "w-screen h-screen font-dm-sans font-medium flex flex-col overflow-y-scroll" };
...
const LegalNoticeView = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/home/runner/work/cooperation_jn_trambus/cooperation_jn_trambus/src/views/LegalNoticeView.vue"]]);
export {
