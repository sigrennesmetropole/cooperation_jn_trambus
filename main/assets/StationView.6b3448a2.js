import { aw as defineComponent, bm as inject, aL as ref, aD as onMounted, aA as openBlock, aE as createElementBlock, aF as Fragment, aG as renderList, ay as createBlock, aI as createCommentVNode, aH as createBaseVNode, bG as useRoute, aC as reactive, aV as onBeforeMount, aB as createVNode, b5 as Nt } from "./vendor.84bced7f.js";
import { b as useMap3dStore, a as useViewsStore, f as usePoiParkingStore, c as useLineInteractionStore, v as viewList } from "./views.3bead5fd.js";
...
import { U as UiStationHeader } from "./UiStationHeader.a5d47329.js";
import { a as apiClientService } from "./api.client.7eea230d.js";
import { S as ServicesStation } from "./ServicesStation.e0808b25.js";
import { I as ItemPOI } from "./ItemPOI.ce36a44f.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { map3dStore, viewStore, layerStore, stationsStore, poiStore, lineInteractionStore, params, routeParams, stationId, lineNumber, state, rennesApp, UiStationHeader, FooterArea: Nt, ServicesStation, PointsOfInterestsStation, BackButton };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
