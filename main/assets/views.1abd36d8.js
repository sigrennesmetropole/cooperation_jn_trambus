import { aK as defineStore, aL as ref, b6 as CesiumMap, b7 as Projection, b8 as Cartographic, b9 as OpenlayersMap, ba as SceneTransforms, bb as Cartesian2, bc as getHeightFromTerrainProvider, bd as mercatorProjection, be as LineString, bf as Feature, bg as Point, bh as getMidPoint, bi as cartesian2DDistance, bj as CatmullRomSpline, bk as Cartesian3, bl as CesiumMath } from "./vendor.9aefb857.js";
import { u as useLayersStore, R as RENNES_LAYER } from "./layers.ef7a09c2.js";
...
defineStore(
  ...
  () => {
    const selectedMetros = ref([]);
    const clickPosition = ref(null);
    const featureLabel = ref(null);
    function selectMetros(metroLines) {
...
defineStore("bus-interaction-map", () => {
  const selectedBusLines = ref([]);
  const clickPosition = ref(null);
  const featureLabel = ref(null);
  function selectBusLines(busLines) {
