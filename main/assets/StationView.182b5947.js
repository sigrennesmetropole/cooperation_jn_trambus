import { aw as defineComponent, bm as inject, aK as ref, aD as onMounted, aA as openBlock, aE as createElementBlock, aF as Fragment, aG as renderList, ay as createBlock, aI as createCommentVNode, aH as createBaseVNode, bG as useRoute, aC as reactive, aV as onBeforeMount, aB as createVNode, b5 as Gt } from "./vendor.bc3132df.js";
import { b as useMap3dStore, a as useViewsStore, f as usePoiParkingStore, c as useLineInteractionStore, v as viewList } from "./views.4b1c9d06.js";
import { R as RENNES_LAYER, u as useLayersStore, a as apiClientService } from "./api.client.0d5166f0.js";
import { u as useStationsStore } from "./stations.a759cc1d.js";
import { U as UiStationHeader } from "./UiStationHeader.d5abf725.js";
import { S as ServicesStation } from "./ServicesStation.962c33b4.js";
import { I as ItemPOI } from "./ItemPOI.1e492fff.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { map3dStore, viewStore, layerStore, stationsStore, poiStore, lineInteractionStore, params, routeParams, stationId, lineNumber, state, rennesApp, UiStationHeader, FooterArea: Gt, ServicesStation, PointsOfInterestsStation, BackButton };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
