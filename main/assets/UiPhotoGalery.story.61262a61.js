import { aw as defineComponent, aA as openBlock, aE as createElementBlock, aB as createVNode, aH as createBaseVNode, aF as Fragment, aG as renderList, aO as normalizeClass, ax as resolveComponent, ay as createBlock, az as withCtx, aY as hstEvent } from "./vendor.ff59799b.js";
import { U as UiPanelControlButton } from "./UiPanelControlButton.4816cf7a.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    const __returned__ = { emit, props, sendEvent, clickImage, UiPanelControlButton };
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$1, [
    ...
    createBaseVNode("div", {
      class: normalizeClass(["flex flex-row items-start p-3 gap-3 w-auto h-56 bg-white rounded-l-xl rounded-r-xl rounded-t-none rounded-b-none", { hidden: !$setup.props.galleryShown }])
    }, [
