import { aw as defineComponent, aN as computed, aA as openBlock, aE as createElementBlock, aO as normalizeClass, aH as createBaseVNode, aB as createVNode, aL as toDisplayString } from "./vendor.ff59799b.js";
import { I as IconLine } from "./IconLine.60c1f014.js";
...
const informationIcon = "/cooperation_jn_trambus/main/assets/informationIcon.4d80bee2.svg";
...
const _hoisted_1 = ["id"];
const _hoisted_2 = { class: "flex flex-col justify-center items-start pt-3 pr-3 pb-3 pl-0" };
const _hoisted_3 = { class: "flex items-center px-0.5 py-0 gap-1 rounded" };
const _hoisted_4 = { class: "font-bold text-base leading-5" };
const _hoisted_5 = ["src"];
const _hoisted_6 = { class: "flex flex-col items-start p-0 gap-1" };
const _hoisted_7 = { class: "font-normal text-xs leading-4 text-neutral-500" };
const _hoisted_8 = { class: "flex flex-col items-start p-0 gap-1 grow" };
const _hoisted_9 = { class: "flex flex-col justify-center items-start p-0 gap-1.5" };
const _hoisted_10 = { class: "font-medium text-sm leading-5" };
const _hoisted_11 = { class: "font-medium text-sm leading-5" };
  ...
  return openBlock(), createElementBlock("div", {
    ...
    createBaseVNode("div", _hoisted_2, [
      createBaseVNode("div", _hoisted_3, [
        ...
        createBaseVNode("div", null, [
          createBaseVNode("img", { src: $setup.informationIcon }, null, 8, _hoisted_5)
        ])
      ]),
      createBaseVNode("div", _hoisted_6, [
        createBaseVNode("div", _hoisted_7, " au lieu de " + toDisplayString($setup.props.oldDuration), 1)
      ])
    ]),
    ...
    createBaseVNode("div", _hoisted_8, [
      createBaseVNode("div", _hoisted_9, [
        createBaseVNode("div", _hoisted_10, toDisplayString($setup.props.startStation), 1),
        createBaseVNode("div", _hoisted_11, toDisplayString($setup.props.endStation), 1)
      ])
    ]),
...
const UiTravelTime = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/home/runner/work/cooperation_jn_trambus/cooperation_jn_trambus/src/components/ui/UiTravelTime.vue"]]);
export {
  UiTravelTime as U
};
