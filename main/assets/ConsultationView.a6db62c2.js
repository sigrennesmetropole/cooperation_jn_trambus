import { aw as defineComponent, aO as computed, aA as openBlock, aE as createElementBlock, aQ as renderSlot, aH as createBaseVNode, aJ as toDisplayString, aP as normalizeClass, aV as onBeforeMount, ax as resolveComponent, aB as createVNode, az as withCtx } from "./vendor.a9455e02.js";
import { a as useViewsStore, v as viewList } from "./views.ee2f36f2.js";
...
const _hoisted_8$1 = { class: "flex flex-row gap-1.5 items-center" };
const _hoisted_9$1 = ["src"];
const _hoisted_10$1 = { class: "font-dm-sans font-normal text-xs" };
const _hoisted_11$1 = { class: "font-dm-sans font-normal text-xs" };
const _hoisted_12 = { class: "flex flex-row gap-3 py-3" };
const _hoisted_13 = { class: "flex flex-row gap-1.5 items-center" };
const _hoisted_14 = ["src"];
const _hoisted_15 = /* @__PURE__ */ createBaseVNode("div", { class: "border border-l border-slate-200" }, null, -1);
const _hoisted_16 = { class: "flex flex-row gap-1.5 items-center" };
const _hoisted_17 = ["src"];
const _hoisted_18 = /* @__PURE__ */ createBaseVNode("div", { class: "border border-l border-slate-200" }, null, -1);
const _hoisted_19 = { class: "flex flex-row gap-1.5 items-center" };
    ...
    createBaseVNode("div", _hoisted_2$2, [
      ...
      createBaseVNode("div", _hoisted_4$1, [
        ...
        createBaseVNode("div", _hoisted_5$1, [
          ...
          createBaseVNode("p", _hoisted_7$1, " Clotur\xE9e le " + toDisplayString($setup.props.date), 1)
        ]),
        createBaseVNode("div", _hoisted_8$1, [
          ...
          createBaseVNode("p", _hoisted_10$1, toDisplayString($setup.props.place), 1)
        ])
      ]),
      createBaseVNode("p", _hoisted_11$1, toDisplayString($setup.props.content), 1),
