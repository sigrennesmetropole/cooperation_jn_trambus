import { aw as defineComponent, aN as ref, aA as openBlock, ay as createBlock, aL as computed, aE as createElementBlock, aH as createBaseVNode, aM as normalizeClass, aJ as toDisplayString, aF as Fragment, aG as renderList, aI as createCommentVNode, aP as defineStore, aC as reactive, aQ as onBeforeMount, aR as pushScopeId, aS as popScopeId, ax as resolveComponent, az as withCtx, aB as createVNode } from "./vendor.f4e583bf.js";
import { a as IconCircleText, I as IconLine } from "./IconLine.7698080a.js";
...
const useInteractionMapStore = defineStore("interaction-map", () => {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    function mouseOverAndLeaveItem(action, stationName) {
      ...
      } else if (action == "over" && stationName != interactionMapStore.selectedStation) {
        interactionMapStore.selectStation(stationName);
      }
    }
    const __returned__ = { props, interactionMapStore, state, mouseOverAndLeaveItem, ItemThermometerStations };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
    ...
    createBaseVNode("div", null, [
      $setup.state.stations !== null && $setup.state.stations.length > 0 ? (openBlock(), createElementBlock("ul", _hoisted_2, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($setup.state.stations, (station, index) => {
          ...
          }, null, 8, ["onMouseover", "onMouseleave", "index", "line", "name", "parking", "desserte", "li_code", "is_last_elem"]);
        }), 128))
      ])) : createCommentVNode("v-if", true)
    ])
  ], 64);
