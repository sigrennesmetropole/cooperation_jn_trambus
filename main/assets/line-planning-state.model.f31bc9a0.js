import { aw as defineComponent, aA as openBlock, aE as createElementBlock, aF as Fragment, aG as renderList, aM as normalizeClass, aH as createBaseVNode, a_ as normalizeStyle, aJ as toDisplayString } from "./vendor.8097ddee.js";
...
LinePlanningStateTypes.UNSTARTED = new _LinePlanningStateTypes(
  "unStarted",
  "Non commenc\xE9",
  "#858585",
  "#bebebe"
);
LinePlanningStateTypes.UNDER_CONSTRUCTION = new _LinePlanningStateTypes(
  "underConstruction",
  "En travaux",
  "#F43F5E",
  "#FDA4AF"
);
LinePlanningStateTypes.CONSTRUCTION_FINISHED = new _LinePlanningStateTypes(
  "constructionFinished",
  "Travaux finalis\xE9s",
  "#FACC15",
  "#FEF08A"
);
LinePlanningStateTypes.COMMISIONING = new _LinePlanningStateTypes(
  "commisioning",
  "Mise en service",
  "#65A30D",
  "#BEF264"
