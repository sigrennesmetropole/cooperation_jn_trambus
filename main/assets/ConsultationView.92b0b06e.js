import { aw as defineComponent, aP as computed, aA as openBlock, aF as createElementBlock, aR as renderSlot, aI as createBaseVNode, aK as toDisplayString, aQ as normalizeClass, aO as createTextVNode, aW as onBeforeMount, ax as resolveComponent, aB as createVNode, az as withCtx } from "./vendor.793d0727.js";
import { a as useViewsStore, v as viewList } from "./views.117ce80b.js";
...
const _hoisted_3$2 = { class: "font-dm-sans font-bold text-base" };
const _hoisted_4$1 = { class: "flex flex-row gap-3 h-8" };
const _hoisted_5$1 = { class: "flex flex-row gap-1.5 items-center" };
const _hoisted_6$1 = ["src"];
const _hoisted_7$1 = { class: "font-dm-sans font-normal text-xs" };
const _hoisted_8$1 = /* @__PURE__ */ createTextVNode(" Clotur\xE9e le ");
const _hoisted_9$1 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_10$1 = { class: "flex flex-row gap-1.5 items-center" };
const _hoisted_11$1 = ["src"];
const _hoisted_12 = { class: "font-dm-sans font-normal text-xs" };
const _hoisted_13 = { class: "font-dm-sans font-normal text-xs" };
const _hoisted_14 = { class: "flex flex-row gap-3 py-3" };
const _hoisted_15 = { class: "flex flex-row gap-1.5 items-center" };
const _hoisted_16 = ["src"];
const _hoisted_17 = /* @__PURE__ */ createBaseVNode("div", { class: "border border-l border-slate-200" }, null, -1);
const _hoisted_18 = { class: "flex flex-row gap-1.5 items-center" };
const _hoisted_19 = ["src"];
const _hoisted_20 = /* @__PURE__ */ createBaseVNode("div", { class: "border border-l border-slate-200" }, null, -1);
const _hoisted_21 = { class: "flex flex-row gap-1.5 items-center" };
const _hoisted_22 = ["src"];
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$2, [
    renderSlot(_ctx.$slots, "img"),
    createBaseVNode("div", _hoisted_2$2, [
      createBaseVNode("p", _hoisted_3$2, toDisplayString($setup.props.title), 1),
      createBaseVNode("div", _hoisted_4$1, [
        ...
        createBaseVNode("div", _hoisted_5$1, [
          ...
          createBaseVNode("p", _hoisted_7$1, [
            _hoisted_8$1,
            _hoisted_9$1,
            createTextVNode(" " + toDisplayString($setup.props.date), 1)
          ])
        ]),
        createBaseVNode("div", _hoisted_10$1, [
          ...
          createBaseVNode("p", _hoisted_12, toDisplayString($setup.props.place), 1)
        ])
      ]),
      createBaseVNode("p", _hoisted_13, toDisplayString($setup.props.content), 1),
...
const ConsultationIllustration = "/cooperation_jn_trambus/main/assets/ex_consultation.0bcfe697.png";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { viewStore, viewList, ChevronArrowRight, ConsultationMeeting, ExplanationComponent, ConsultationIllustration };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
const _hoisted_10 = /* @__PURE__ */ createBaseVNode("h2", { class: "font-dm-sans font-bold text-lg leading-6 border-b border-b-slate-200 mt-6 pb-6" }, " Les concertations termin\xE9es ", -1);
      ...
      createVNode($setup["ConsultationMeeting"], {
        ...
        img: withCtx(() => [
          createBaseVNode("img", {
            ...
            src: $setup.ConsultationIllustration,
